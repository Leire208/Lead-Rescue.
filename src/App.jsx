  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#050505] text-white selection:bg-white selection:text-black">
      ...
      <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute left-1/2 top-[-280px] h-[600px] w-[900px] -translate-x-1/2 rounded-full bg-blue-500/[0.06] blur-[140px]" />
        <div className="absolute bottom-[-250px] right-[-150px] h-[500px] w-[500px] rounded-full bg-purple-500/[0.05] blur-[140px]" />
      </div>

      {/* NAVBAR */}
      <header className="fixed left-0 right-0 top-0 z-50 border-b border-white/[0.06] bg-[#050505]/75 backdrop-blur-2xl">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 sm:px-8">
          <button
            onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
            className="group flex items-center gap-2"
          >
            <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-white text-black transition-transform duration-300 group-hover:scale-105">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="hidden rounded-full bg-white px-4 py-2 text-xs font-semibold text-black transition hover:bg-white/90 sm:block"
            >
              {t.nav.getStarted}
            </a>
          </div>
      ...
      <main>
        <section className="relative px-5 pb-20 pt-40 sm:px-8 sm:pt-48">
          <div className="mx-auto max-w-6xl text-center">
            <div className="mb-7 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.035] px-4 py-2">
              <span className="h-1.5 w-1.5 rounded-full bg-blue-400" />

              <span className="text-[10px] font-semibold tracking-[0.18em] text-white/55">
                {t.hero.eyebrow}
              </span>
            </div>

            <h1 className="mx-auto max-w-5xl text-5xl font-semibold leading-[0.95] tracking-[-0.055em] sm:text-7xl lg:text-[92px]">
              {t.hero.title1}
              <br />
            ...
            <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group flex w-full items-center justify-center gap-2 rounded-full bg-white px-6 py-3.5 text-sm font-semibold text-black transition hover:bg-white/90 sm:w-auto"
              >
                {t.hero.primary}
              ...
              <button
                onClick={() => scrollToSection("how-it-works")}
                className="flex w-full items-center justify-center rounded-full border border-white/10 bg-white/[0.03] px-6 py-3.5 text-sm font-medium text-white/75 transition hover:border-white/20 hover:bg-white/[0.06] hover:text-white sm:w-auto"
              >
                {t.hero.secondary}
              </button>
            </div>

            <div className="mt-7 flex items-center justify-center gap-2 text-xs text-white/30">
              <Check size={13} />
              {t.hero.trusted}
            </div>
          </div>
          ...
          <div className="mx-auto mt-20 max-w-5xl">
            <div className="relative overflow-hidden rounded-[28px] border border-white/10 bg-[#0b0b0c] shadow-2xl shadow-black/50">
              <div className="flex h-11 items-center gap-2 border-b border-white/[0.06] px-5">
                <span className="h-2.5 w-2.5 rounded-full bg-white/15" />
                <span className="h-2.5 w-2.5 rounded-full bg-white/15" />
                <span className="h-2.5 w-2.5 rounded-full bg-white/15" />

                <div className="mx-auto hidden rounded-md border border-white/[0.05] bg-white/[0.025] px-20 py-1.5 sm:block">
              ...
              <div className="grid min-h-[360px] grid-cols-1 gap-0 md:grid-cols-3">
                <div className="border-b border-white/[0.06] p-6 md:border-b-0 md:border-r">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="mt-6 h-1.5 w-full rounded-full bg-white/[0.06]" />
                    ...
                    <div className="pt-5">
                      ...
                      <div className="mt-2 h-1.5 w-[90%] rounded-full bg-white/[0.05]" />
                      <div className="mt-2 h-1.5 w-[78%] rounded-full bg-white/[0.05]" />
                    </div>
                  </div>
                </div>

                <div className="relative flex items-center justify-center border-b border-white/[0.06] p-6 md:border-b-0 md:border-r">
                  ...
                  <div className="relative flex flex-col items-center text-center">
                    <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl border border-white/10 bg-white/[0.05]">
                      <Sparkles size={23} className="text-white/70" />
                    </div>
                    ...
                    <span className="mt-3 text-[10px] text-white/25">
                      {t.mockup.generating}
                    </span>
                  </div>
                </div>
        ...
        <section
          id="how-it-works"
          className="scroll-mt-24 border-t border-white/[0.06] px-5 py-28 sm:px-8"
        >
          <div className="mx-auto max-w-6xl">
            <div className="max-w-2xl">
              ...
              <h2 className="mt-5 text-4xl font-semibold tracking-[-0.045em] sm:text-6xl">
                {t.how.title1}
                <br />
                <span className="text-white/40">{t.how.title2}</span>
              </h2>
            ...
            <div className="mt-16 grid gap-4 md:grid-cols-3">
              {steps.map((step) => {
                ...
                return (
                  <div
                    key={step.number}
                    className="group rounded-[24px] border border-white/[0.08] bg-white/[0.025] p-7 transition duration-300 hover:border-white/[0.15] hover:bg-white/[0.04]"
                  >
        ...
        <section className="px-5 py-28 sm:px-8">
          <div className="mx-auto max-w-6xl">
            <div className="grid items-end gap-10 lg:grid-cols-2">
              <div>
                ...
                <h2 className="mt-5 text-4xl font-semibold tracking-[-0.045em] sm:text-6xl">
                  {t.why.title1}
                  <br />
                  <span className="text-white/40">{t.why.title2}</span>
                </h2>
              </div>
            ...
            <div className="mt-16 grid gap-4 md:grid-cols-2">
              <div className="rounded-[26px] border border-white/[0.06] bg-white/[0.018] p-7">
              ...
              <div className="rounded-[26px] border border-white/10 bg-white/[0.035] p-7 shadow-xl shadow-black/20">
        ...
        {/* STARTING OPTIONS */}
        <section className="border-y border-white/[0.06] px-5 py-28 sm:px-8">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-14 grid gap-4 md:grid-cols-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group rounded-[28px] border border-white/[0.08] bg-white/[0.025] p-8 transition duration-300 hover:-translate-y-1 hover:border-white/[0.16] hover:bg-white/[0.04]"
              >
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 bg-white/[0.04]">
                  <FileText size={20} className="text-white/65" />
                </div>

                <h3 className="mt-8 text-xl font-medium tracking-[-0.025em]">
                  {t.options.existingTitle}
                </h3>

                <p className="mt-3 max-w-md text-sm leading-6 text-white/35">
                  {t.options.existingDescription}
                </p>

                <div className="mt-8 flex items-center gap-2 text-sm font-medium text-white/70">
                  {t.options.existingButton}
              ...
              >
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 bg-white/[0.04]">
                  <Sparkles size={20} className="text-white/65" />
                </div>

                <h3 className="mt-8 text-xl font-medium tracking-[-0.025em]">
                  {t.options.scratchTitle}
                </h3>

                <p className="mt-3 max-w-md text-sm leading-6 text-white/35">
                  {t.options.scratchDescription}
                </p>

                <div className="mt-8 flex items-center gap-2 text-sm font-medium text-white/70">
                  {t.options.scratchButton}
        ...
        >
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-16 grid gap-px overflow-hidden rounded-[28px] border border-white/[0.06] bg-white/[0.06] sm:grid-cols-2 lg:grid-cols-3">
              {featureItems.map((feature) => {
                ...
                return (
                  <div
                    key={feature.title}
                    className="bg-[#080808] p-7 transition hover:bg-white/[0.025]"
                  >
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-white/[0.08] bg-white/[0.03]">
                      <Icon size={17} className="text-white/55" />
                    </div>
        ...
        >
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mx-auto mt-16 grid max-w-5xl gap-5 lg:grid-cols-2">
              {/* MONTHLY */}
              <div className="relative flex flex-col rounded-[30px] border border-white/[0.08] bg-white/[0.025] p-8 sm:p-9">
                <div>
                  ...
                  <div className="mt-7 flex items-end gap-2">
                    ...
                    <span className="mb-1.5 text-sm text-white/30">
                      {t.pricing.perMonth}
                    </span>
                  </div>
                </div>
                ...
                <p className="mb-5 text-xs font-semibold uppercase tracking-[0.14em] text-white/30">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="mt-6 flex w-full items-center justify-center rounded-full border border-white/10 bg-white/[0.04] px-5 py-3.5 text-sm font-semibold text-white transition hover:border-white/20 hover:bg-white/[0.08]"
                >
              ...
              {/* SIX MONTHS */}
              <div className="relative flex flex-col overflow-hidden rounded-[30px] border border-white/20 bg-white/[0.055] p-8 shadow-2xl shadow-black/30 sm:p-9">
                <div className="pointer-events-none absolute right-0 top-0 h-64 w-64 rounded-full bg-blue-500/[0.07] blur-[100px]" />

                <div className="absolute right-6 top-6 rounded-full border border-white/10 bg-white px-3 py-1.5">
                  <span className="text-[9px] font-bold tracking-[0.12em] text-black">
                    {t.pricing.bestValue}
                  </span>
                </div>
                ...
                <div className="relative">
                  <div className="flex flex-wrap items-center gap-3 pr-28">
                    ...
                    <span className="rounded-full border border-white/10 bg-white/[0.06] px-2.5 py-1 text-[9px] font-bold tracking-[0.08em] text-white/60">
                      {t.pricing.save}
                    </span>
                  </div>
                  ...
                  <div className="mt-3 flex flex-wrap items-center gap-2">
                    <span className="rounded-full bg-white/[0.08] px-3 py-1.5 text-[11px] font-medium text-white/65">
                ...
                <div className="relative">
                  <p className="mb-5 text-xs font-semibold uppercase tracking-[0.14em] text-white/40">
                    {t.pricing.included}
                  </p>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="relative mt-9 flex w-full items-center justify-center gap-2 rounded-full bg-white px-5 py-3.5 text-sm font-semibold text-black transition hover:bg-white/90"
                >
                  {t.pricing.sixButton}
        ...
        {/* FAQ */}
        <section className="border-t border-white/[0.06] px-5 py-28 sm:px-8">
          <div className="mx-auto max-w-4xl">
            <div className="text-center">
              ...
              <h2 className="mt-5 text-4xl font-semibold tracking-[-0.045em] sm:text-6xl">
                {t.faq.title1}
                <br />
                <span className="text-white/40">{t.faq.title2}</span>
              </h2>
            </div>
        ...
        <section className="px-5 py-28 sm:px-8 sm:py-36">
          <div className="relative mx-auto max-w-5xl overflow-hidden rounded-[32px] border border-white/10 bg-white/[0.035] px-6 py-20 text-center sm:px-10">
            <div className="pointer-events-none absolute left-1/2 top-[-180px] h-[350px] w-[600px] -translate-x-1/2 rounded-full bg-blue-500/[0.07] blur-[110px]" />
            ...
            <div className="relative">
              ...
              <h2 className="mx-auto mt-5 max-w-3xl text-4xl font-semibold tracking-[-0.05em] sm:text-6xl">
                {t.final.title1}
                <br />
                <span className="text-white/40">{t.final.title2}</span>
              </h2>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group mx-auto mt-9 flex w-fit items-center gap-2 rounded-full bg-white px-6 py-3.5 text-sm font-semibold text-black transition hover:bg-white/90"
              >
                {t.final.button}
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-8 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-semibold">HireKit AI</span>
            </div>
